...
annotation_iroki<-vgp_bird_table%>%select(LatinName,NumV,Length,avg_inv_len,avg_num_inversions,inv_cov_frac,frac_genes_on_inv)
colnames(annotation_iroki)[1]<-"name"
colnames(annotation_iroki)[2]<-"bar1_height"
colnames(annotation_iroki)[3]<-"bar2_height"
colnames(annotation_iroki)[4]<-"bar3_height"
colnames(annotation_iroki)[5]<-"bar4_height"
colnames(annotation_iroki)[7]<-"bar5_height"
...
annotation_iroki<-annotation_iroki[-4]
